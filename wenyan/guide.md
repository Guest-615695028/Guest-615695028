...
|`整二有`|2|-32768~32767
|`整二無`|2|0~65535
|`整四有`|4|-2,147,483,648~2,147,483,647
|`整四無`|4|0~4,294,967,295
|`整八有`|8|-9,223,372,036,854,775,808~9,223,372,036,854,775,807
|`整八無`|8|0~18,446,744,073,709,551,615
## 語句
一以句點終。
### 聲明變量
`（類型）「變量名」置（式），［「變量名」置（式），⋯⋯］`
