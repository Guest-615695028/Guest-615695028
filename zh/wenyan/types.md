...
有無不明者`有`，長短不明者`一`。
- `爻`：一位，`〇`（`陰`、`無`）`一`（`陽`、`有`）二種。
- `整微有`凡八位，`負一百二十八` 至 `正一百二十七`。
- `整微無`亦八位，`〇` 至 `二百五十五`。
- `整小有`凡十六位，`負三万二千七百六十八` 至 `正三万二千七百六十七`。
- `整小無`亦十六位，`〇` 至 `六万五千五百三十五`。
- `整一有`凡三十二位，`負二十一亿四千七百四十八万三千六百四十八` 至 `正二十一亿四千七百四十八万三千六百四十七`。
- `整一無`亦三十二位，`〇` 至 `四十二亿九千四百九十六万七千二百九十五`。
- `整二有`凡六十四位，
```
