# 中文
漢語（書面語稱爲中文）是全球使用人數最多的語言，使用者共有近16億人（八種漢語：華語、粵語、閩語、客語、吳語、湘語、贛語、晋語，因共同書面語不視爲獨立語言）。

自2019年冠狀病毒爆發以來，中文國際影響力不斷擴大，已有八十一國家將漢語、中文納入國民教育體系。有一日，[外國女子取快遞説漢語，快遞員説英語](https://roll.sohu.com/a/719676820_100199564)，暗含個別國人對漢語國際化的認識不足和文化不自信。2023年，莫斯科國立大學亞非學院院長阿列克謝·馬斯洛夫表示，[2033年俄羅斯漢語普及率將與英語相當](https://sputniknews.cn/20230420/1049714051.html)。

爲方便中國境内（含港澳臺及三沙群島）大衆媒體引用，類比臉書（Facebook）、推特（Twitter）、優管（YouTube），本人將本網站（Github）音義合譯作「結合網」（粵語：_Git3 hap6 mong5_）。

## 使用正體中文
正體中文（合法、規範）不稱繁體中文（非法、不規範）。若有人以本人名義使用簡體中文撰寫文本，視同侵犯知識產權。
...
標題若以自造詞或縮寫詞（認爲可能作產品商標）加冒號或逗號開始，可放棄翻譯該詞，如[*Mobi2Sense: Empowering Wireless Sensing with Mobility*](https://dl.acm.org/doi/pdf/10.1145/3495243.3560518)譯作《「動感」 ：移動性增强無綫感知》。

據《2023年中國科技論文統計報告》，中國熱點論文（被引量排名前千分之一）計1969篇，佔世界總量45.9%，比2022年增加6.7%，世界排名保持第1位，美國位列第2；中國高被引論文（被引量排名前百分之一）計57900篇，佔世界總量30.8%，世界排名保持在第2位，僅次於美國。按國外論文被引用次數统计，中國在農業科學、化學、計算機科學、工程技術、材料科學和數學6个學科排名世界第1位，较2022年度新增了數學學科。究其原因，一方面是中文的高效率使中國中學生學習進度普遍比西方快約二年，大學生也應該如此，例如美國高等教育計算機科學教材《算法導論》（第三版，美國英文：Introduction to Algorithms (2009), Thomas H. Cormen et al）正文從1229頁到715頁。

## 漢語、中文國際化建設之下一階段目標
### 學術界
1. 增加中文論文發表數量、比率，等額取代並限制發表英文論文，清查國内英文期刊亂象，推進中文科學引文索引建設；
2. 發表西文（英、法、德文等拉丁文字母書寫的語言文字）、俄文論文時[强制補充中文作者人名、機構名](https://news.sciencenet.cn/sbhtmlnews/2021/3/361309.shtm)以便檢索，因爲漢字拉丁文轉寫（四國均有，尤其是不標調號）將同音不同字轉寫爲同一拼寫，重名率提高了數十倍乃至數百倍。
...
2. 對制裁漢語教學的國家之官方語言教學予以同等制裁；
3. 增多外語教學語種，降低英語佔中學生修讀外語比例至25-50%，小學畢業即分流外語。
----
據瞭解，美國製造業嚴重依賴中國，但又限制購買華爲、中興等先進企業出口產品，中國如果對等限制美國在中國代工，並通過進口產品秘密逆推其核心技術（硬件逆合成、軟件反匯編等），美國就會逐漸失去超級大國之位。

實現以上目標，才能讓越來越多外國人迫不及待學漢語，發揮漢語、中文的信息密度優勢，節省印刷用紙和計算機存儲空間；才能阻止且必能有效抑制人才外流和重大技術泄露，保護我國國家安全，真正提升我國國際競爭力。臺灣當局刪減國文課綱，就是不想看到「國文興，英文滅」，「危及」自身「統治」。

本組階段目標完成之時，預計于2035年，漢語有望成爲繼英語之後第二門世界級中心語言，通用於人文與社會科學界。2049年，「一帶一路」建設完成，英美霸權終結，各國各界民衆將迫不及待學習漢語、中文，使之真正成爲第一種非侵略全球跨界通用語文。
