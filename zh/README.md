...
衆所周知，英語成爲國際通用語是因爲英國搞殖民擴張；尤其美國發明計算機、互聯網以來，各大編程語言詞匯基於英文。然而作爲愛國公民，我們反感在中文語境内（參考文獻區除外，按引用順序排列）直接寫入作品、期刊、會議的英文標題而不是翻譯之，其他外文亦然；推薦用書名號標注自行翻譯的中文名，括註外文原文，如《雙電學會知識與數據工程匯刊》（IEEE Transactions on Knowledge and Data Engineering）。
