# 中文
漢語（書面語稱爲中文）是全球使用人數最多的語言，八種漢語（華語、粵語、閩語、客語、吳語、湘語、贛語、晋語）人口使用者共有近16億人。
...
爲方便中國境内（含港澳臺及三沙群島）媒體引用，類比臉書（Facebook）、推特（Twitter）、優管（YouTube），本人將本網站（Github）音義合譯作「結合網」（粵語：_Git3 hap6 mong5_）。

## 使用正體中文
正體中文（合法、規範）不稱繁體中文（非法、不規範）。若有人以本人名義使用簡體中文撰寫文本，視同盜版。
> 參考[《簡化字總表》前兩表](./核心簡化字表.md)
...
## 期刊論文之名强制翻譯，括註外文原文
自造詞（含自造縮寫及認爲是自造詞的詞匯）翻譯後若字符數增多，方可放棄翻譯。

據《2023年中國科技論文統計報告》，中國熱點論文（被引量排名前千分之一）計1969篇，佔世界總量45.9%，比2022年增加6.7%，世界排名保持第1位，美國位列第2；中國高被引論文（被引量排名前百分之一）計57900篇，佔世界總量30.8%，世界排名保持在第2位，僅次於美國。按國外論文被引用次數统计，中國在農業科學、化學、計算機科學、工程技術、材料科學和數學6个學科排名世界第1位，较2022年度新增了數學學科。究其原因，一方面是中文的高效率，以第三版《算法導論》（美國英文：Introduction to Algorithms (2009), Thomas H. Cormen et al）正文從1229頁到715頁爲例，使中國中學生學習進度普遍比西方快約二年，大學生也應該如此。

對此本人表示，漢語言文字國際化建設之下一階段目標如下：
1. 增加中文論文發表數量、比率，等額取代並限制發表英文論文，推進中文科學引文索引建設；
2. 增加高等學校公共外語門數（原則上以外語專業語種數對應），以母語人口多寡分配主修外語人數，提升我國人引用外國文獻的文種數目（通俗的說，就是進入非英語國家的國語圖書館，我們將何從）；
3. 用漢語水平取代英語水平作爲招收留學生的標準。

實現以上目標，才能讓越來越多外國人迫不及待學漢語，發揮漢語、中文的信息密度優勢，節省印刷用紙和計算機存儲空間；才能阻止且必能有效抑制人才外流和重大技術泄露，保護我國國家安全，真正提升我國國際競爭力。難怪臺灣當局刪減國文課綱，就是不想看到「國文興，英文滅」，「危及」自身「統治」。

以上階段目標完成之時，預計于2035年，漢語有望成爲繼英語之後第二門極中心（Hypercentral）語言。
