...
## 使用正體中文
正體中文（合法、規範）不稱繁體中文（非法、不規範）。若有人以本人名義使用簡體中文撰寫文本，視同侵犯本人知識產權。
> 參考[《簡化字總表》前兩表](./simplifications.md)

所謂「通用規範漢字表」仍之，但有個別例外，如「碱」代替了「鹼」（硷）。

## 拒絕歐化中文
二十世紀初，西風東漸，[周樹人](https://zh.wikipedia.org/wiki/周樹人)等中國文人希望以「直譯歐文句法」的方式改造中文，進而「改造中國人思考方式」。周謂：「歐化文法的侵入中國白話的大原因，並非因爲好奇，乃是爲了必要。」中國音韻學家[錢玄同](https://zh.wikipedia.org/wiki/錢玄同)亦積極主張廢除漢字，改用歐洲的語文，並認爲中國文字的意義太模糊，文法不精確，不足以「代表新世界」的進步思想；[余光中](https://zh.wikipedia.org/wiki/余光中)、[蔡濯堂](https://zh.wikipedia.org/wiki/蔡濯堂)等人極力反對之。
### 歐化中文特徵
1. 抽象名詞作主語
...
## 音譯還是意譯？
玄奘五種不翻，不合者皆意譯：
1. 秘密故，如「陀羅尼（梵：dhāraṇī）」（佛教經文的一種，類似咒語）。
